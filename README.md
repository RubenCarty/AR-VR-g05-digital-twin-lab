...
Gemelo digital de un laboratorio universitario con monitoreo en tiempo real vía IoT + AR.

| Campo | Detalle |
|-------|---------|
| **Tipo XR** | AR + IoT |
| **Motor** | Unity 2022.3.62f1 |
| **Tecnología principal** | AR Foundation + UnityWebRequest (REST API) |
...
- AR Foundation 5.1.x
- AR Foundation + UnityWebRequest (REST API)

### Clonar el repositorio

```bash
git clone https://github.com/RubenCarty/rva-g05-digital-twin-lab.git
cd rva-g05-digital-twin-lab
```
